...
importScripts('./assets/js/imi-environments.js');

let env = imiEnvironments[imiEnvironments.target];
let config = env.sw.config;
firebase.initializeApp(config);
var messaging = firebase.messaging();
console.log('SW: messaging ready', messaging);
